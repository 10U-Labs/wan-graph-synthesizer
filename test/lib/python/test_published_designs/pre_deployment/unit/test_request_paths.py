...
The order matters as much as the set does. The build state gates whether the four
...
def test_the_build_state_is_asked_for_before_the_collections_it_gates() -> None:
    """Every path is the tenant's, the state leads, and the four collections follow."""
