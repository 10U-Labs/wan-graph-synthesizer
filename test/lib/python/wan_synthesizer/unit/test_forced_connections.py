...
tiers, and the synthesizer honors them -- rather than any particular city pin.
"""
...
from wan_synthesizer.overrides import resolve_forced_links
from wan_synthesizer.model import ForcedConnection, ForcedLinks
