...
from wan_synthesizer.synthesize import (
    AggregationHoming,
...
from wan_synthesizer.output import tier_breakdown
...
from wan_synthesizer.validation import vertex_role
from wan_synthesizer.strength import vertex_straightness
