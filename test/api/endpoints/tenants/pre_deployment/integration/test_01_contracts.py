"""Layer 1 (contracts): cross-file consistency for the tenants stack.

The tenants stack couples to the shared common module (whose outputs its locals
...
def _stack_text() -> str:
    """Return the combined text of the tenants stack's main.tf and iam.tf."""
