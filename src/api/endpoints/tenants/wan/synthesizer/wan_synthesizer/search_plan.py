...
builds and consumes them lives in :mod:`wan_synthesizer.synthesize`.
"""
...
from wan_synthesizer.model import ForcedLinks, Tuning
...
class ClusterPlan:
    ...
    cluster's head genuinely nearby (see :func:`wan_synthesizer.synthesize.cluster_local_heads`).
    """
