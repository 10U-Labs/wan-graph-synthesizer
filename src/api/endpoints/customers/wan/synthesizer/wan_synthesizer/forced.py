...
:class:`~wan_synthesizer.model.ForcedLinks` bundle; these helpers consume it while
the synthesizer routes a design, so the pinned edges are honored: core-core pairs
...
synthesizer imports them without a cycle.
"""

from __future__ import annotations

from wan_graph.model import Vertex, haversine_miles
from wan_synthesizer.model import ForcedLinks
