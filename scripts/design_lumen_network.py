...
Inputs:
* KMZ/KML point data for F-35, Sentinel, provider provider regions, and Lumen PoPs.
...
Design model:
* Access tier: every F-35, Sentinel, and provider provider node is an access node.
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "input",
        nargs="?",
        default="f35_sentinel_provider regions_lumen_400g.kmz",
